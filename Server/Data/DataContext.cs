...
public class DataContext : DbContext
{
  ...
  protected override void OnModelCreating(ModelBuilder modelBuilder)
  {
    modelBuilder.Entity<Category>().HasData(
      new Category { Id = 1, Name = "Books", Url = "books", Icon = "oi oi-book" },
      new Category { Id = 2, Name = "Movies", Url = "movies", Icon = "oi oi-bullhorn" },
      new Category { Id = 3, Name = "Video Games", Url = "video-games", Icon = "oi oi-game-controller" }
    );
